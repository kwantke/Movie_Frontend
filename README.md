...
### 기본 구성
- Reactjs + Typescript 언어로 개발.
- 로그인(회원가입), 영화 메인 및 상세(영상), 검색 기능 구현
...
### 영화 로그인 화면
 - 로그인 및 회원 가입 기능 구현
 - JWT Token 기반 방식으로 로그인 구현
 - Redux를 활용하여 로그인(Token) 관리
...
### 영화 메인 화면
- Netflix와 같은 테마별 영화 리스트 구현 
- Swiper 기능 추가하여 가로로 슬라이드 적용
...
### 영화 검색 화면
<img src="https://user-images.githubusercontent.com/100019970/233858594-2e6191af-a0ea-4204-a65b-972ce3aa0b96.JPG" width="500" height="500">
